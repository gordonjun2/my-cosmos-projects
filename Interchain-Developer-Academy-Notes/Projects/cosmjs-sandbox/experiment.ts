...
const runAll = async (): Promise<void> => {
    ...
    console.log(
        "Alice balances:",
        await client.getAllBalances("cosmos1csjzjgzrg04tn0rdz579896wp2qxsdmhakj40r")
    )
    const faucetTx: IndexedTx = (await client.getTx(
        "FD6089F4A9F5D2F8AAF0354EC06162CEB9B031CD4BA03BC4A657B9F61DB89507"
    ))!
    ...
    const validator: string = "cosmosvaloper1s5jrzpfjc3xe2f2rd0dmkf0clatq785yv9txul" // blockscape

    // method to atomically send tokens to multiple recipients
