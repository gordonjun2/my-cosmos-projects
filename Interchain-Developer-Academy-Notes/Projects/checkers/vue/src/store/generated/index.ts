...
import AliceCheckersAliceCheckersLeaderboard from './alice/checkers/alice.checkers.leaderboard'
...
export default { 
  ...
  AliceCheckersAliceCheckersLeaderboard: load(AliceCheckersAliceCheckersLeaderboard, 'alice.checkers.leaderboard'),
